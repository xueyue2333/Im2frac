...
if __name__ == '__main__':
    ...
    #   Dataset\scan3\dense
    parser.add_argument('--dense_folder', type=str, default=r'D:\A-Fkf\MVSNet_pytorch-master\new_data\out27\dense', help='Project dir.')
    ...
    for i in range(len(images)):
        for j in range(i + 1, len(images)):
            queue.append((i, j, images, extrinsic, points3d, args))
    ...
    """
    好像是生成图片的，但是colmap里面已经生成过一遍了，就给他p掉吧
    for i in range(num_images):
